...
const sendEmail = async (email:string, uniqueString:string, verify:string) => {
	...
	let mailOptions = {
	  ...
	  <body class="flex justify-center items-center my-4">
		<div style="border-radius: 1rem; width: 30rem; height: 15rem; box-shadow: rgba(0, 0, 0, 0.15) 1.95px 1.95px 2.6px;">
		  <div style="width: 100%; height: 40%; background: linear-gradient(88.35deg, #573E81 0.84%, #6E5D8B 98.46%);
		  border-radius: 1rem  1rem 0 0;" class="w-full h-[40%] bg-gradient-to-r from-[#573E81] to-[#6E5D8B] rounded-t-3xl flex justify-center items-center">
